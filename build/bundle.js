...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } /* main.js -- the entry point to our app; pull in the other modules */
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* model.js -- stores our appointments, the current time, and will
...
var Model = function () {
    ...
    _createClass(Model, [{
        ...
        value: function getDays() {
            var days = [],
                calendarStart = (0, _moment2.default)(this.now).startOf('month'),
                calendarEnd = (0, _moment2.default)(this.now).endOf('month'),
                timeRange = calendarEnd.valueOf() - calendarStart.valueOf(),
                daysInView = Math.floor(_moment2.default.duration(timeRange).asDays());

            for (var i = 0; i <= daysInView; i += 1) {
                days.push({
...
function _taggedTemplateLiteral(strings, raw) { return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /* template.js -- where our template functions will live */
/* jshint esversion:6 */
